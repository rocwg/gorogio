...
- 将昂贵的、需要精细优化的**高性能代码（大象）限制在最小的必要范围内**（例如，只占整个业务系统的 10%）。
- 将大部分的**业务逻辑、用户交互（骑手）用生产力更高、开发更快的高级语言来实现**。
...
**参考文献：**
 Introducing the Rider and Elephant Software Architecture – [地址](https://d-gate.io/blog/rider-and-elephant-architecture) 
